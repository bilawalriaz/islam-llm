 ...
 * - Format selection: Landscape, Square (Instagram), Portrait (Stories)
 */
function ShareButton({ surahId, ayahNumber, surahName, translation = 'en.sahih' }) {
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            const url = getAyahShareImageUrl(surahId, ayahNumber, translation, isSquare, isPortrait, 'png') + `&t=${timestamp}`;
            setImageUrl(url);
    ...
    }, [isOpen, surahId, ayahNumber, translation, imageFormat]);
