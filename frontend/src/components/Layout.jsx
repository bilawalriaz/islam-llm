        ...
        <>
            <div className="container">
                <header className="header">
                    ...
                    {isAuthenticated ? (
                        <>
                            {/* Header right controls - search always visible */}
                            <div className="header-right-controls">
                                <NavLink to="/search" className={({ isActive }) => `nav-link-icon header-search-btn ${isActive ? 'active' : ''}`} title="Search the Quran">
                            ...
                            <div className={`mobile-menu-wrapper ${mobileMenuOpen ? 'open' : ''}`}>
                                <nav className="nav-links">
                                    ...
                                    <NavLink to="/events" className={({ isActive }) => `nav-link nav-link-icon ${isActive ? 'active' : ''}`} onClick={closeMobileMenu}>
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        ...
                                        <span className="nav-link-text">This Day in History</span>
                                    </NavLink>
                        ...
                        <>
                            {/* Header right controls - search always visible */}
                            <div className="header-right-controls">
                                <Link to="/search" className="nav-link-icon header-search-btn" title="Search the Quran">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <circle cx="11" cy="11" r="8"></circle>
                                        <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
                                    </svg>
                            ...
                            <div className={`mobile-menu-wrapper ${mobileMenuOpen ? 'open' : ''}`}>
                                <div className="auth-links">
                                    <Link to="/events" className="nav-link nav-link-icon" onClick={closeMobileMenu} title="Islamic Events">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                            <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                                            <line x1="16" y1="2" x2="16" y2="6"></line>
                                            <line x1="8" y1="2" x2="8" y2="6"></line>
